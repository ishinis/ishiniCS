    ...
    if submitted:
        ...
        with st.expander("About this prediction"):
            st.write(
                ...
                The confidence levels, shown in the chart below, indicate the stacking model's certainty (as a percentage) 
                in assigning the input to each credit score category. Higher values suggest greater certainty.
                """
            )
